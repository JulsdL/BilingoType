...
// Maps old section IDs to current ones for backward-compatible deep-linking
...
export default function SettingsModal({ open, onOpenChange, initialSection }: SettingsModalProps) {
  ...
  const sidebarItems: SidebarItem<SettingsSectionType>[] = useMemo(
    () => [
      ...
      {
        id: "dictionary",
        label: t("settingsModal.sections.dictionary.label", { defaultValue: "Dictionary" }),
        icon: BookOpen,
        description: t("settingsModal.sections.dictionary.description", { defaultValue: "Custom words and phrases" }),
        group: t("settingsModal.groups.speechAi"),
      },
      {
        id: "agentConfig",
        ...
        icon: UserCog,
        description: t("settingsModal.sections.agentConfig.description", { defaultValue: "Voice assistant configuration" }),
        group: t("settingsModal.groups.speechAi"),
      },
      {
        id: "privacyData",
