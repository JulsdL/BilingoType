  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem
          onClick={async () => {
            const result = await window.electronAPI?.openExternal("mailto:support@bilingotype.com");
            if (!result?.success) {
              openExternal("https://mail.google.com/mail/?view=cm&to=support@bilingotype.com");
            }
          }}
        >
        ...
        <DropdownMenuItem
          onClick={() => openExternal("https://github.com/JulsdL/BilingoType/issues")}
        >
